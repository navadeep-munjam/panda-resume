    ...
    try {
      ...
      const typingInterval = setInterval(() => {
        if (i < data.content.length) {
          botContent = data.content.substring(0, i + 1);
          setMessages(prev => [
            ...prev.slice(0, -1),
      ...
      <AnimatePresence>
        {isOpen ? (
          <motion.div
            ...
            className={`bg-white rounded-2xl shadow-2xl border border-gray-200 flex flex-col overflow-hidden ${isOpen ? 'w-[90vw] h-[70vh] sm:w-96 sm:h-[500px]' : 'w-16 h-16'
              }`}
          >
                ...
                <div className="space-y-3">
                  <AnimatePresence>
                    {messages.map((m, i) => (
                      ...
                      >
                        <div
                          className={`p-3 rounded-2xl max-w-[85%] text-sm sm:text-base ${m.role === 'user'
